...
from .modules import authorize, list, cancel_mirror, mirror_status, mirror, clone, watch, anime, search, delete, speedtest
from bot import BLOCK_MEGA_LINKS, BLOCK_MEGA_FOLDER, MAX_TORRENT_SIZE
