...
ANIME_HANDLER = CommandHandler("anime5", anime)
CHARACTER_HANDLER = CommandHandler("character5", character)
MANGA_HANDLER = CommandHandler("manga5", manga)
WEEBHELP_HANDLER = CommandHandler("weebhelp5", weebhelp)
